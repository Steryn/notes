export default [
  {
    ...
    "items": [
      { "text": "起步", "link": "start" },
      { "text": "高级主题学习大纲总结", "link": "ADVANCED_TOPICS_SUMMARY" },
      { "text": "文档目录结", "link": "DOC_STRUCTURE_SUMMARY" },
    ]
  },
  {
    "text": "学习阶段",
    "items": [
      {
        "text": "基础概念", "link": "01-basics/README", items: [
          { "text": "Node.js 基础概念", "link": "01-basics/README" },
          { "text": "模块系统和包管理", "link": "01-basics/modules" },
          { "text": "事件循环和异步编程", "link": "01-basics/async" },
          { "text": "文件系统操作", "link": "01-basics/filesystem" },
          { "text": "HTTP模块和网络编程", "link": "01-basics/http" }
        ]
      },
      {
        "text": "Express框架", "link": "02-express/README", items: [
          { "text": "Express简介", "link": "02-express/README" },
          { "text": "路由和中间件", "link": "02-express/routing-middleware" },
          { "text": "请求处理和响应", "link": "02-express/request-response" },
          { "text": "静态文件服务", "link": "02-express/static-files" },
          { "text": "错误处理", "link": "02-express/error-handling" },
        ]
      },
      {
